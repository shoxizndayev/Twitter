...
function FooterImagesBox(){
   return(
      <div className='images-box'>
         <img src={firstImg} alt="images"  width='123' height='88' />
         <img src={secondImg} alt="images"  width='123' height='88' />
         <img src={thirdImg} alt="images"  width='123' height='88' />
         <img src={fourthImg} alt="images"  width='123' height='88' />
         <img src={fifthImg} alt="images"  width='123' height='88' />
         <img src={sixthImg} alt="images" width={123} height={88} />
